...
import { getAllProducts, getAllProductTypes } from '../redux';
		...
		<React.Fragment>
			<Container disableGutters maxWidth='lg' component='main' sx={{ pt: 8, pb: 6 }}>
				...
				<Typography variant='h5' align='center' color='text.secondary' component='p'>
					Everything from Stocks and Mutual Funds to IPO and FDs. Explore our offerings at
					your one stop investing destination, Groww.
				</Typography>
			</Container>
			{/* Products */}
